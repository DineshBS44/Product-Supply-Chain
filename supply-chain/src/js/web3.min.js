...
})(
  {
    ...
    4: [
      function (t, e, r) {
        ...
        (((o.prototype = new i({})).constructor = o).prototype.isType =
          function (t) {
              ...
              if (e.isDynamicArray(u))
                for (var f = a === i ? 2 : 0, l = 0; l < r.length; l++)
                  a === i
                    ? (f += +r[l - 1][0] || 0)
                    : a === o && (f += +(r[l - 1] || [])[0] || 0),
                    (h += y.formatInputInt(n + l * c + 32 * f).encode());
              for (
                var p = a === i ? r.length - 1 : r.length, d = 0;
                d < p;
                d++
              ) {
                var m = h / 2;
                a === i
                  ? (h += this.encodeWithOffset(u, e, r[d + 1], n + m))
                  : a === o && (h += this.encodeWithOffset(u, e, r[d], n + m));
              }
              return h;
            }
            return r;
        ...
        (i.prototype.isType = function (t) {
          ...
          (i.prototype.encode = function (i, o) {
            var t,
              ...
              r,
              s = this;
            return this.isDynamicArray(o)
              ? ((t = i.length),
                (e = s.nestedName(o)),
                (r = []).push(n.formatInputInt(t).encode()),
                i.forEach(function (t) {
                  r.push(s.encode(t, e));
                }),
                r)
              : this.isStaticArray(o)
              ? (function () {
                  for (
                    var t = s.staticArrayLength(o),
                      e = s.nestedName(o),
                      r = [],
                      n = 0;
                    n < t;
          ...
          (i.prototype.decode = function (u, c, h) {
            ...
            if (this.isDynamicArray(h))
              return (function () {
                for (
                  var t = parseInt("0x" + u.substr(2 * c, 64)),
                    e = parseInt("0x" + u.substr(2 * t, 64)),
                    r = t + 32,
                    n = f.nestedName(h),
                    i = f.staticPartLength(n),
                    o = 32 * Math.floor((i + 31) / 32),
                    s = [],
                    a = 0;
                  a < e * o;
                  a += o
                )
                  s.push(f.decode(u, r + a, n));
                return s;
              })();
            if (this.isStaticArray(h))
              return (function () {
                for (
                  var t = f.staticArrayLength(h),
                    e = c,
                    r = f.nestedName(h),
                    n = f.staticPartLength(r),
                    i = 32 * Math.floor((n + 31) / 32),
                    o = [],
                    s = 0;
                  s < t * i;
                  ...
                  o.push(f.decode(u, e + s, r));
                return o;
              })();
            if (this.isDynamicType(h))
              return (
                (t = parseInt("0x" + u.substr(2 * c, 64))),
                (e = parseInt("0x" + u.substr(2 * t, 64))),
                (r = Math.floor((e + 31) / 32)),
                (n = new s(u.substr(2 * t, 64 * (1 + r)), 0)),
                f._outputFormatter(n, h)
              );
      ...
      function (t, e, r) {
        ...
        e.exports = function (t, e) {
          return (
            e &&
              "hex" === e.encoding &&
              (2 < t.length && "0x" === t.substr(0, 2) && (t = t.substr(2)),
              (t = n.enc.Hex.parse(t))),
            i(t, { outputLength: 256 }).toString()
          );
        };
      },
      { "crypto-js": 66, "crypto-js/sha3": 87 },
    ],
    20: [
      function (t, e, r) {
        var n = t("bignumber.js"),
          ...
          d = function (t) {
            ...
            for (var e = i(t.toLowerCase()), r = 0; r < 40; r++)
              if (
                (7 < parseInt(e[r], 16) && t[r].toUpperCase() !== t[r]) ||
          ...
          m = function (t) {
            return (
              t &&
              (t instanceof n ||
                (t.constructor && "BigNumber" === t.constructor.name))
            );
          },
          y = function (t) {
            return (
      ...
      { "./sha3.js": 19, "bignumber.js": "bignumber.js", utf8: 124 },
    ],
    21: [
      function (t, e, r) {
      ...
      function (t, e, r) {
        ...
        function x(t) {
          (this._requestManager = new n(t)),
            ...
            (this.debug = new f(this)),
            (this.bzz = new h(this)),
            (this.settings = new l()),
            (this.version = { api: p.version }),
            (this.providers = { HttpProvider: b, IpcProvider: _ }),
            (this._extend = y(this)),
            this._extend({ properties: k() });
        }
        (x.providers = { HttpProvider: b, IpcProvider: _ }),
          ...
          (x.prototype.BigNumber = w),
          (x.prototype.toHex = d.toHex),
          (x.prototype.toAscii = d.toAscii),
          (x.prototype.toUtf8 = d.toUtf8),
          (x.prototype.fromAscii = d.fromAscii),
          (x.prototype.fromUtf8 = d.fromUtf8),
          (x.prototype.toDecimal = d.toDecimal),
          (x.prototype.fromDecimal = d.fromDecimal),
          (x.prototype.toBigNumber = d.toBigNumber),
          (x.prototype.toWei = d.toWei),
          (x.prototype.fromWei = d.fromWei),
          (x.prototype.isAddress = d.isAddress),
          (x.prototype.isChecksumAddress = d.isChecksumAddress),
          (x.prototype.toChecksumAddress = d.toChecksumAddress),
          (x.prototype.isIBAN = d.isIBAN),
          (x.prototype.padLeft = d.padLeft),
          (x.prototype.padRight = d.padRight),
          (x.prototype.sha3 = function (t, e) {
            return "0x" + m(t, e);
          }),
      ...
      function (t, e, r) {
        ...
        (c.prototype.encode = function (e) {
          ...
          (c.prototype.decode = function (t) {
            t.data = t.data || "";
            var e =
                s.isArray(t.topics) && s.isString(t.topics[0])
                  ? t.topics[0].slice(2)
                  : "",
            ...
            return r
              ? new i(this._requestManager, r, this._address).decode(t)
              : o.outputLogFormatter(t);
          }),
                  ...
                  .forEach(function (t, e) {
                    if (n[e].callback) {
                      if (!i.isValidResponse(t))
                        return n[e].callback(o.InvalidResponse(t));
                      n[e].callback(
                        null,
                        n[e].format ? n[e].format(t.result) : t.result
                      );
                    }
                  });
            });
      ...
      function (t, e, r) {
        var u = t("../utils/utils"),
          ...
          h = function (e) {
            ...
            new s(e._eth._requestManager, t, e.address).attachToContract(e),
              t
                .map(function (t) {
              ...
              s = n._eth.filter("latest", function (t) {
                if (!t && !o)
                  if (50 < ++e) {
                    ...
                    n._eth.getTransactionReceipt(
                      n.transactionHash,
                      function (t, r) {
                        r &&
                          r.blockHash &&
                          !o &&
                          n._eth.getCode(r.contractAddress, function (t, e) {
                            if (!o && e)
                              if (
                                (s.stopWatching(function () {}),
                                (o = !0),
                                3 < e.length)
                              )
                                (n.address = r.contractAddress),
                                  a(n),
                                  h(n),
                                  i && i(null, n);
                              else {
          ...
          l = function (t, a) {
            (this.eth = t),
              ...
              (this.new = function () {
                ...
                var i = e[e.length - 1];
                if (
                  (u.isObject(i) && !u.isArray(i) && (t = e.pop()),
                  0 < t.value) &&
                  !(
                    a.filter(function (t) {
                      return (
      ...
      function (t, e, r) {
        e.exports = {
          InvalidNumberOfSolidityArgs: function (t) {
            return new Error(
              "Invalid number of arguments to Solidity function: " + t
            );
          },
          InvalidNumberOfRPCParams: function (t) {
            return new Error(
              "Invalid number of input parameters to RPC method: " + t
            );
          },
          ...
          ConnectionTimeout: function (t) {
            return new Error(
              "CONNECTION TIMEOUT: timeout of " + t + " ms achieved"
            );
          },
        };
      },
      ...
      function (t, e, r) {
        ...
        (i.prototype.types = function (e) {
          ...
          (i.prototype.execute = function (t, e, r) {
            o.isFunction(arguments[arguments.length - 1]) &&
      ...
      function (t, e, r) {
        ...
        e.exports = function (r) {
          var t = function (t) {
            var e;
            t.property
              ? (r[t.property] || (r[t.property] = {}), (e = r[t.property]))
              : (e = r),
              t.methods &&
    ...
    29: [
      function (t, e, r) {
        var c = t("./formatters"),
          ...
          p = function (r) {
            r.requestManager.startPolling(
              { method: r.implementation.poll.call, params: [r.filterId] },
              r.filterId,
              function (e, t) {
                if (e)
            ...
            return (
              ...
              this.implementation.newFilter(this.options, function (e, t) {
                if (e)
                  ...
                  ((a.filterId = t),
                  a.getLogsCallbacks.forEach(function (t) {
                    a.get(t);
                  }),
                  (a.getLogsCallbacks = []),
                  a.callbacks.forEach(function (t) {
        ...
        (n.prototype.watch = function (t) {
          return (
            this.callbacks.push(t), this.filterId && (l(this, t), p(this)), this
          );
        }),
          ...
          (n.prototype.get = function (r) {
            ...
            return (
              null === this.filterId
                ? this.getLogsCallbacks.push(r)
                : this.implementation.getLogs(this.filterId, function (t, e) {
                    t
                      ? r(t)
                      : r(
                          null,
      ...
      function (t, e, r) {
        ...
        e.exports = {
          ...
          inputCallFormatter: function (e) {
            return (
              (e.from = e.from || i.defaultAccount),
          ...
          inputGetLogsFormatter: function (t) {
            t.fromBlock && (t.fromBlock = s(t.fromBlock)),
              t.toBlock && (t.toBlock = s(t.toBlock));
          },
    ...
    32: [
      function (e, r, t) {
        (function (n) {
          ...
          "undefined" != typeof window && window.XMLHttpRequest
            ...
            : (XMLHttpRequest = e("xmlhttprequest").XMLHttpRequest);
          ...
          (t.prototype.prepareRequest = function (t) {
            ...
            if (
              ...
              var r =
                "Basic " +
                new n(this.user + ":" + this.password).toString("base64");
      ...
      { "./errors": 26, buffer: 54, "xhr2-cookies": 127, xmlhttprequest: 17 },
    ],
    33: [
      function (t, e, r) {
        var n = t("bignumber.js"),
            ...
            t
              ...
              .forEach(function (e) {
                ...
                try {
                  ...
                  return (
                    (r.lastChunk = e),
                    clearTimeout(r.lastChunkTimeout),
                    void (r.lastChunkTimeout = setTimeout(function () {
        ...
        (o.prototype.setRequestManager = function (t) {
          ...
          (o.prototype.formatInput = function (r) {
            return this.inputFormatter
              ? this.inputFormatter.map(function (t, e) {
                  return t ? t(r[e]) : r[e];
                })
              : r;
          }),
          ...
          (o.prototype.buildCall = function () {
            var n = this,
              t = function () {
                ...
                return r.callback
                  ? n.requestManager.sendAsync(r, function (t, e) {
    ...
    39: [
      function (t, e, r) {
        ...
        var v = t("../formatters"),
          ...
          f = t("../transfer"),
          w = function (t) {
            return b.isString(t[0]) && 0 === t[0].indexOf("0x")
              ? "eth_getBlockByHash"
        ...
        function l(t) {
          ...
          p().forEach(function (t) {
            ...
            (this.iban = h),
            (this.sendIBANTransaction = f.bind(null, this));
        }
        ...
        var p = function () {
            ...
            return [
              ...
              l,
              d,
              new _({ name: "submitWork", call: "eth_submitWork", params: 3 }),
              g,
              new _({ name: "getWork", call: "eth_getWork", params: 0 }),
            ];
          },
          d = function () {
            return [
              new n({ name: "coinbase", getter: "eth_coinbase" }),
              new n({ name: "mining", getter: "eth_mining" }),
              new n({
                name: "hashrate",
                getter: "eth_hashrate",
                outputFormatter: b.toDecimal,
              ...
              new n({ name: "accounts", getter: "eth_accounts" }),
              new n({
                name: "blockNumber",
                getter: "eth_blockNumber",
                outputFormatter: b.toDecimal,
              }),
              new n({ name: "protocolVersion", getter: "eth_protocolVersion" }),
            ];
          };
    ...
    40: [
      function (t, e, r) {
        var n = t("../../utils/utils"),
          ...
          o = function () {
            return [
              new i({ name: "listening", getter: "net_listening" }),
              new i({
                name: "peerCount",
      ...
      function (t, e, r) {
        ...
        e.exports = function (t) {
          ...
          [e, r, o, i, n, s, a]).forEach(function (t) {
            ...
            [
              new h({ name: "listAccounts", getter: "personal_listAccounts" }),
            ].forEach(function (t) {
              t.attachToObject(u), t.setRequestManager(u._requestManager);
            });
        };
      },
      { "../formatters": 30, "../method": 36, "../property": 46 },
    ],
    42: [
      function (t, e, r) {
        var n = t("../method"),
      ...
      { "../filter": 29, "../method": 36, "./watches": 44 },
    ],
    43: [
      function (t, e, r) {
        "use strict";
        ...
        e.exports = function (t) {
          ...
          [e, r, n, i, o, s, a, u, c, h]).forEach(function (t) {
            ...
            [
              new p({ name: "hive", getter: "bzz_hive" }),
              new p({ name: "info", getter: "bzz_info" }),
            ].forEach(function (t) {
              t.attachToObject(f), t.setRequestManager(f._requestManager);
            });
        };
      },
      { "../method": 36, "../property": 46 },
    ],
    44: [
      function (t, e, r) {
        var n = t("../method");
          ...
          (n.prototype.sendAsync = function (t, r) {
            ...
            this.provider.sendAsync(e, function (t, e) {
              return t
                ? r(t)
                : s.isValidResponse(e)
                ? void r(null, e.result)
                : r(c.InvalidResponse(e));
            });
          }),
                  ...
                  this.provider.sendAsync(n, function (t, e) {
                    if (!t) {
                      ...
                      e.map(function (t) {
                        ...
                        return (
                          !!o.polls[e] &&
                          ((t.callback = o.polls[e].callback), t)
                        );
                      })
                        .filter(function (t) {
                          return !!t;
        ...
        var i = t("./formatters"),
          ...
          n = function (t, e) {
            ...
            return (
              ...
              (n = this).requestManager.startPolling(
                ...
                function (e, r) {
                  ...
                  o.isObject(r) &&
                    r.startingBlock &&
                    (r = i.outputSyncingFormatter(r)),
                    n.callbacks.forEach(function (t) {
                      n.lastSyncState !== r &&
                        (!n.lastSyncState && o.isObject(r) && t(null, !0),
                        setTimeout(function () {
                          t(null, r);
                        }, 0),
                        (n.lastSyncState = r));
        ...
        (r.byteLength = function (t) {
          ...
          (r.toByteArray = function (t) {
            for (
              ...
              (e =
                (f[t.charCodeAt(u)] << 18) |
                (f[t.charCodeAt(u + 1)] << 12) |
                (f[t.charCodeAt(u + 2)] << 6) |
                f[t.charCodeAt(u + 3)]),
                (o[s++] = (e >> 16) & 255),
                (o[s++] = (e >> 8) & 255),
                (o[s++] = 255 & e);
            var c, h;
            2 === i &&
              ((e = (f[t.charCodeAt(u)] << 2) | (f[t.charCodeAt(u + 1)] >> 4)),
              (o[s++] = 255 & e));
            1 === i &&
              ((e =
                (f[t.charCodeAt(u)] << 10) |
                (f[t.charCodeAt(u + 1)] << 4) |
                (f[t.charCodeAt(u + 2)] >> 2)),
              (o[s++] = (e >> 8) & 255),
              (o[s++] = 255 & e));
            return o;
          }),
      ...
      function (t, e, r) {
          ...
          (f.prototype.write = function (t, e, r, n) {
            ...
            for (var o, s, a, u, c, h, f, l, p, d = !1; ; )
              switch (n) {
                ...
                case "utf-8":
                  return (
                    (l = e), (p = r), P(N(t, (f = this).length - l), f, l, p)
                  );
                case "ascii":
                  return v(this, t, e, r);
                case "latin1":
        ...
        (f.prototype.slice = function (t, e) {
          ...
          (f.prototype.readFloatLE = function (t, e) {
            return (
              (t >>>= 0), e || A(t, 4, this.length), o.read(this, t, !0, 23, 4)
            );
          }),
          (f.prototype.readFloatBE = function (t, e) {
            return (
              (t >>>= 0), e || A(t, 4, this.length), o.read(this, t, !1, 23, 4)
            );
          }),
          (f.prototype.readDoubleLE = function (t, e) {
            return (
              (t >>>= 0), e || A(t, 8, this.length), o.read(this, t, !0, 52, 8)
            );
          }),
          (f.prototype.readDoubleBE = function (t, e) {
            return (
              (t >>>= 0), e || A(t, 8, this.length), o.read(this, t, !1, 52, 8)
            );
          }),
    ...
    56: [
      function (t, e, r) {
        !(function () {
          ...
          (i.All = Object.freeze(Object.create(null))),
            (r.CookieAccessInfo = i),
            ((r.Cookie = u).prototype.toString = function () {
          ...
          function t() {
            ...
            return this instanceof t
              ? ((o = Object.create(null)),
                (this.setCookie = function (t, e, r) {
                  var n, i;
                  if (
                    ((n = (t = new u(t, e, r)).expiration_date <= Date.now()),
                    void 0 !== o[t.name])
                  ) {
          ...
          (u.prototype.parse = function (t, e, r) {
            if (this instanceof u) {
              ...
              for (this.name = s, this.value = a, n = 1; n < i.length; n += 1)
                switch (
                  ((s = (o = i[n].match(/([^=]+)(?:=([\s\S]*))?/))[1]
                    .trim()
                    .toLowerCase()),
            ...
            ((r.CookieJar = t).prototype.setCookies = function (t, e, r) {
              var n,
                ...
                o = [];
              for (
                t = (t = Array.isArray(t) ? t : t.split(s)).map(function (t) {
                  return new u(t, e, r);
                }),
                  n = 0;
                n < t.length;
                ...
                (i = t[n]), this.setCookie(i, e, r) && o.push(i);
              return o;
            });
        })();
      },
                ...
                !(function () {
                  ...
                  for (e = 0; e < 256; e++) {
                    ...
                    (f[r] = (u << 24) | (u >>> 8)),
                      ...
                      (d[r] = u);
                    u =
                      (16843009 * a) ^ (65537 * s) ^ (257 * o) ^ (16843008 * r);
                    (m[i] = (u << 24) | (u >>> 8)),
                      (y[i] = (u << 16) | (u >>> 16)),
                      (g[i] = (u << 8) | (u >>> 24)),
                      (v[i] = u),
                      r
                        ? ((r = o ^ t[t[t[a ^ o]]]), (n ^= t[t[n]]))
                        : (r = n = 1);
                  }
                })();
                  ...
                  n = (r.AES = e.extend({
                    _doReset: function () {
                      if (!this._nRounds || this._keyPriorReset !== this._key) {
                        ...
                        for (
                          var a = (this._invKeySchedule = []), u = 0;
                          u < n;
                          u++
                        ) {
                          o = n - u;
              ...
              (g = (e.kdf = {}).OpenSSL =
                {
                  execute: function (t, e, r, n) {
                    n || (n = u.random(8));
                    var i = a.create({ keySize: e + r }).compute(t, n),
                      o = u.create(i.words.slice(e), 4 * r);
                    return (
                      (i.sigBytes = 4 * e), d.create({ key: i, iv: o, salt: n })
                    );
                  },
                }),
                    ...
                    _process: function (t) {
                      var e = this._data,
                        ...
                        s =
                          (o = t
                            ? h.ceil(o)
                            : h.max((0 | o) - this._minBufferSize, 0)) * i,
                        a = h.min(4 * s, n);
                      if (s) {
                        for (var u = 0; u < s; u += i)
    ...
    63: [
      function (t, e, r) {
        ...
        (n = this),
          ...
          "object" == typeof r
            ? (e.exports = r = i(t("./core"), t("./sha1"), t("./hmac")))
            : "function" == typeof define && define.amd
            ? define(["./core", "./sha1", "./hmac"], i)
            : i(n.CryptoJS);
      },
      { "./core": 60, "./hmac": 65, "./sha1": 84 },
    ],
    64: [
      function (t, e, r) {
        var n, i;
        (n = this),
          ...
          "object" == typeof r
            ? (e.exports = r = i(t("./core"), t("./cipher-core")))
            : "function" == typeof define && define.amd
            ? define(["./core", "./cipher-core"], i)
            : i(n.CryptoJS);
      },
      { "./cipher-core": 59, "./core": 60 },
    ],
    65: [
      function (t, e, r) {
        var n, i;
                ...
                n.extend({
                  ...
                  compute: function (t, e) {
                    for (
                      ...
                      n.reset();
                      for (
                        var f = h.words, l = f.length, p = h, d = 1;
                        d < c;
                        d++
                      ) {
              ...
              (function () {
                ...
                function l() {
                  ...
                  (e[0] = (e[0] + 1295307597 + this._b) | 0),
                    (e[1] =
                      (e[1] + 3545052371 + (e[0] >>> 0 < u[0] >>> 0 ? 1 : 0)) |
                      0),
                    (e[2] =
                      (e[2] + 886263092 + (e[1] >>> 0 < u[1] >>> 0 ? 1 : 0)) |
                      0),
                    (e[3] =
                      (e[3] + 1295307597 + (e[2] >>> 0 < u[2] >>> 0 ? 1 : 0)) |
                      0),
                    (e[4] =
                      (e[4] + 3545052371 + (e[3] >>> 0 < u[3] >>> 0 ? 1 : 0)) |
                      0),
                    (e[5] =
                      (e[5] + 886263092 + (e[4] >>> 0 < u[4] >>> 0 ? 1 : 0)) |
                      0),
                    (e[6] =
                      (e[6] + 1295307597 + (e[5] >>> 0 < u[5] >>> 0 ? 1 : 0)) |
                      0),
                    (e[7] =
                      (e[7] + 3545052371 + (e[6] >>> 0 < u[6] >>> 0 ? 1 : 0)) |
                      0),
          ...
          (i = function (a) {
            return (
              (function (t) {
                ...
                (e.RIPEMD160 = i._createHelper(s)),
                  (e.HmacRIPEMD160 = i._createHmacHelper(s));
              })(Math),
              a.RIPEMD160
            );
          }),
    ...
    85: [
      function (t, e, r) {
        ...
        (n = this),
          ...
          "object" == typeof r
            ? (e.exports = r = i(t("./core"), t("./sha256")))
            : "function" == typeof define && define.amd
            ? define(["./core", "./sha256"], i)
            : i(n.CryptoJS);
      },
      { "./core": 60, "./sha256": 86 },
    ],
          ...
          (i = function (o) {
            return (
              (function (l) {
                      ...
                      for (u = 0; u < 5; u++)
                        for (f = 0; f < 5; f++) {
                          var S = r[(g = u + 5 * f)],
                            ...
                            A = M[((u + 1) % 5) + 5 * f],
                            C = M[((u + 2) % 5) + 5 * f];
                          (S.high = E.high ^ (~A.high & C.high)),
                            (S.low = E.low ^ (~A.low & C.low));
                        }
                      S = r[0];
                      var B = O[a];
                ...
                (t.SHA3 = n._createHelper(i)),
                  (t.HmacSHA3 = n._createHmacHelper(i));
              })(Math),
              o.SHA3
            );
          }),
    ...
    88: [
      function (t, e, r) {
        ...
        (n = this),
          ...
          "object" == typeof r
            ? (e.exports = r = i(t("./core"), t("./x64-core"), t("./sha512")))
            : "function" == typeof define && define.amd
            ? define(["./core", "./x64-core", "./sha512"], i)
            : i(n.CryptoJS);
      },
      { "./core": 60, "./sha512": 89, "./x64-core": 91 },
    ],
    89: [
      function (t, e, r) {
        var n, i;
          ...
          (i = function (u) {
            return (
              (function () {
                    ...
                    for (
                      ...
                      (q = H),
                        ...
                        (C =
                          (wt +
                            (dt + lt + (xt >>> 0 < mt >>> 0 ? 1 : 0)) +
                            ((B = (ct + xt) | 0) >>> 0 < ct >>> 0 ? 1 : 0)) |
                          0);
                    }
                    (l = n.low = l + B),
                      (n.high = f + C + (l >>> 0 < B >>> 0 ? 1 : 0)),
                      (d = i.low = d + R),
                      (i.high = p + T + (d >>> 0 < R >>> 0 ? 1 : 0)),
                      (y = o.low = y + M),
                      (o.high = m + O + (y >>> 0 < M >>> 0 ? 1 : 0)),
                      (v = s.low = v + I),
                      (s.high = g + N + (v >>> 0 < I >>> 0 ? 1 : 0)),
                      (_ = a.low = _ + j),
                      (a.high = b + P + (_ >>> 0 < j >>> 0 ? 1 : 0)),
                      (x = u.low = x + D),
                      (u.high = w + F + (x >>> 0 < D >>> 0 ? 1 : 0)),
                      (S = c.low = S + L),
                      (c.high = k + H + (S >>> 0 < L >>> 0 ? 1 : 0)),
                      (A = h.low = A + U),
                      (h.high = E + q + (A >>> 0 < U >>> 0 ? 1 : 0));
                  },
                  _doFinalize: function () {
                    var t = this._data,
                      e = t.words,
                ...
                (t.SHA512 = e._createHelper(a)),
                  (t.HmacSHA512 = e._createHmacHelper(a));
              })(),
              u.SHA512
            );
          }),
      ...
      function (t, e, r) {
        (r.read = function (t, e, r, n, i) {
          var o,
            ...
            p = t[e + f];
          for (
            f += l, o = p & ((1 << -h) - 1), p >>= -h, h += a;
            0 < h;
            o = 256 * o + t[e + f], f += l, h -= 8
          );
          for (
            s = o & ((1 << -h) - 1), o >>= -h, h += n;
            0 < h;
              ...
              e = Math.abs(e),
                isNaN(e) || e === 1 / 0
                  ...
                  : ((s = Math.floor(Math.log(e) / Math.LN2)),
                    ...
                    2 <=
                      (e += 1 <= s + f ? l / u : l * Math.pow(2, 1 - f)) * u &&
                      (s++, (u /= 2)),
                    h <= s + f
                      ? ((a = 0), (s = h))
                      : 1 <= s + f
                      ? ((a = (e * u - 1) * Math.pow(2, i)), (s += f))
                      : ((a = e * Math.pow(2, f - 1) * Math.pow(2, i)),
                        (s = 0)));
              8 <= i;
          ...
          !(function (t) {
            ...
            function d(t, e) {
              ...
              return (
                ...
                n + p((t = t.replace(h, ".")).split("."), e).join(".")
              );
            }
            function C(t) {
            ...
            function m(t) {
              ...
              for ((r = t.lastIndexOf(k)) < 0 && (r = 0), n = 0; n < r; ++n)
                128 <= t.charCodeAt(n) && A("not-basic"),
                  l.push(t.charCodeAt(n));
              for (i = 0 < r ? r + 1 : 0; i < p; ) {
                for (
                  o = d, s = 1, a = v;
                  p <= i && A("invalid-input"),
                    ...
                    (v <=
                      ...
                      A("overflow"),
                    (d += u * s),
                    !(u < (c = a <= y ? b : y + _ <= a ? _ : a - y));
                  a += v
                )
                  s > S(g / (h = v - c)) && A("overflow"), (s *= h);
                (y = R(d - o, (e = l.length + 1), 0 == o)),
                  S(d / e) > g - m && A("overflow"),
                  (m += S(d / e)),
                  (d %= e),
                  l.splice(d++, 0, m);
              }
            ...
            function y(t) {
              ...
              for (l = (t = C(t)).length, e = x, o = w, s = r = 0; s < l; ++s)
                (f = t[s]) < 128 && y.push(E(f));
              for (n = i = y.length, i && y.push(k); n < l; ) {
                for (a = g, s = 0; s < l; ++s)
                  e <= (f = t[s]) && f < a && (a = f);
                for (
                  a - e > S((g - r) / (p = n + 1)) && A("overflow"),
                    r += (a - e) * p,
                    e = a,
                    s = 0;
                  s < l;
            ...
            "object" == typeof r
              ? a(u(r), function (t) {
                  ...
                  return s(r[t])
                    ...
                    : e + encodeURIComponent(o(r[t]));
                }).join(n)
              : t
              ? encodeURIComponent(o(t)) + i + encodeURIComponent(o(r))
              : ""
          );
        };
        var s =
    ...
    106: [
      ...
      { "./_stream_transform": 108, "core-util-is": 57, inherits: 95 },
    ],
    107: [
      function (N, I, t) {
        (function (y, t) {
          ...
          function o(t, e) {
            ...
            (this.highWaterMark =
              ...
              (this.encoding = null),
              t.encoding &&
                (a || (a = N("string_decoder/").StringDecoder),
          ...
          function x(t) {
            ...
            (e.needReadable = !1),
              e.emittedReadable ||
                (_("emitReadable", e.flowing),
                (e.emittedReadable = !0),
                e.sync ? g.nextTick(k, t) : k(t));
          }
          function k(t) {
          ...
          function E(t, e) {
            for (
              ...
              (_("maybeReadMore read 0"), t.read(0), r !== e.length);
          ...
          function C(t, e) {
            e.reading || (_("resume read 0"), t.read(0)),
              (e.resumeScheduled = !1),
              (e.awaitDrain = 0),
              t.emit("resume"),
              B(t),
          ...
          (l.prototype.read = function (t) {
            ...
            if (
              ...
              return (
                _("read: emitReadable", e.length, e.ended),
            ...
            return (
              ...
              (0 === e.length || e.length - t < e.highWaterMark) &&
                _("length less than watermark", (i = !0)),
              e.ended || e.reading
                ? _("reading or ended", (i = !1))
                : i &&
                  (_("do read"),
                  (e.reading = !0),
                  (e.sync = !0),
            ...
            (l.prototype.pipe = function (r, t) {
              ...
              var e =
                (!t || !1 !== t.end) && r !== y.stdout && r !== y.stderr
                  ? s
                  : m;
              function o(t, e) {
                _("onunpipe"),
              ...
              i.endEmitted ? g.nextTick(e) : n.once("end", e),
                r.on("unpipe", o);
              var a,
                u =
                  ((a = n),
              ...
              return (
                ...
                r.once("finish", d),
                r.emit("pipe", n),
                i.flowing || (_("pipe resume"), n.resume()),
                r
              );
            }),
              ...
              function (t, e) {
                ...
                if ("data" === t)
                  ...
                  n.endEmitted ||
                    ...
                    (n.emittedReadable = !1),
                    n.reading ? n.length && x(this) : g.nextTick(A, this));
                }
                return r;
              }),
            (l.prototype.resume = function () {
              ...
              return (
                r.flowing ||
                  ...
                  (t = this),
                  (e = r).resumeScheduled ||
                    ((e.resumeScheduled = !0), g.nextTick(C, t, e))),
                this
              );
            }),
            ...
            (l.prototype.wrap = function (e) {
              ...
              for (var o = 0; o < f.length; o++)
                e.on(f[o], this.emit.bind(this, f[o]));
              return (
    ...
    108: [
      ...
      { "./_stream_duplex": 105, "core-util-is": 57, inherits: 95 },
    ],
    109: [
      function (k, S, t) {
        (function (t, e, r) {
          ...
          var a,
            l =
              !t.browser &&
              -1 < ["v0.10", "v0.9."].indexOf(t.version.slice(0, 5))
                ? r
                : g.nextTick;
          h.WritableState = c;
          var n = k("core-util-is");
          n.inherits = k("inherits");
          var i = { deprecate: k("util-deprecate") },
          ...
          function h(t) {
            if (
              ((a = a || k("./_stream_duplex")),
              !(s.call(h, this) || this instanceof a))
            )
              return new h(t);
            ...
            if (t._writev && r && r.next) {
              ...
              for (; r; ) {
                var u = r.chunk,
                  ...
                  h = r.callback;
                if (
                  (w(t, e, !1, e.objectMode ? 1 : u.length, u, c, h),
                  (r = r.next),
              ...
              i &&
                ...
                (n = e).prefinished ||
                  ...
                  ("function" == typeof r._final
                    ? (n.pendingcb++, (n.finalCalled = !0), g.nextTick(y, r, n))
              ...
              ? ((s = Function.prototype[Symbol.hasInstance]),
                Object.defineProperty(h, Symbol.hasInstance, {
                  value: function (t) {
                    return (
                      !!s.call(this, t) ||
                      (this === h && t && t._writableState instanceof c)
                    );
                  },
                }))
              : (s = function (t) {
              ...
              return (
                ...
                d.ended
                  ...
                  : (y ||
                      ...
                      h && (o.emit("error", h), g.nextTick(u, h), (c = !1)),
                      c)) &&
                    (d.pendingcb++,
              ...
              "function" == typeof t
                ...
                n.ending ||
                  ...
                  (function (t, e, r) {
                    (e.ending = !0),
                      x(t, e),
                      r && (e.finished ? g.nextTick(r) : t.once("finish", r));
    ...
    114: [
      function (t, e, r) {
        ((((r = e.exports = t("./lib/_stream_readable.js")).Stream =
          r).Readable = r).Writable = t("./lib/_stream_writable.js")),
      ...
      function (r, t, i) {
        (function (u) {
          ...
          (n.request = function (t, e) {
            ...
            var r =
                -1 === u.location.protocol.search(/^https?:$/) ? "http:" : "",
              n = t.protocol || r,
              i = t.hostname || t.host,
              o = t.port,
              s = t.path || "/";
    ...
    117: [
      function (t, e, a) {
        (function (t) {
          (a.fetch = s(t.fetch) && s(t.ReadableStream)),
            (a.writableStream = s(t.WritableStream)),
            (a.abortController = s(t.AbortController)),
            (a.blobConstructor = !1);
          try {
          ...
          (a.arraybuffer = a.fetch || (i && n("arraybuffer"))),
            (a.msstream = !a.fetch && o && n("ms-stream")),
            (a.mozchunkedarraybuffer =
              !a.fetch && i && n("moz-chunked-arraybuffer")),
            (a.overrideMimeType =
              a.fetch || (!!r() && s(r().overrideMimeType))),
            (a.vbArray = s(t.VBArray)),
            (e = null);
        }.call(
          this,
          "undefined" != typeof global
      ...
      function (o, a, t) {
        (function (u, c, h) {
          ...
          var n = (a.exports = function (e) {
            ...
            s.Writable.call(r),
              ...
              e.auth &&
                r.setHeader(
                  "Authorization",
                  "Basic " + new h(e.auth).toString("base64")
                ),
          ...
          t(n, s.Writable),
                ...
                if (
                  ...
                  if (f.abortController) {
                    ...
                    (o = s.signal),
                      ...
                      "requestTimeout" in t &&
                        0 !== t.requestTimeout &&
                        (e._fetchTimer = c.setTimeout(function () {
                  ...
                  "responseType" in a &&
                    (a.responseType = e._mode.split(":")[0]),
            ...
            (n.prototype.abort = n.prototype.destroy =
              function () {
                (this._destroyed = !0),
                  c.clearTimeout(this._fetchTimer),
            ...
            (n.prototype.end = function (t, e, r) {
              "function" == typeof t && ((r = t), (t = void 0)),
                s.Writable.prototype.end.call(this, t, e, r);
            }),
                  ...
                  t
                    ...
                    .forEach(function (t) {
                      ...
                      if (e) {
                        ...
                        "set-cookie" === r
                          ? (void 0 === i.headers[r] && (i.headers[r] = []),
                            i.headers[r].push(e[2]))
                          : void 0 !== i.headers[r]
                          ? (i.headers[r] += ", " + e[2])
                          : (i.headers[r] = e[2]),
            ...
            (e.prototype._onXHRProgress = function () {
              ...
              switch (e._mode) {
                ...
                case "moz-chunked-arraybuffer":
                  if (((r = t.response), t.readyState !== a.LOADING || !r))
                    break;
                ...
                case "ms-stream":
                  ...
                  (s.onprogress = function () {
                    s.result.byteLength > e._pos &&
                      (e.push(new f(new Uint8Array(s.result.slice(e._pos)))),
    ...
    121: [
      function (t, e, r) {
        ...
        e.exports = function (t) {
          ...
          if (i.isBuffer(t)) {
            for (
              var e = new Uint8Array(t.length), r = t.length, n = 0;
              n < r;
              n++
            )
              e[n] = t[n];
    ...
    122: [
      function (t, e, r) {
        ...
        (C.prototype.parse = function (t, e, r) {
          ...
          if (!z[u] && (h || (u && !W[u]))) {
            ...
            -1 !==
              (l = -1 === p ? s.lastIndexOf("@") : s.lastIndexOf("@", p)) &&
              ((f = s.slice(0, l)),
              (s = s.slice(l + 1)),
            ...
            255 < this.hostname.length
              ...
              y || (this.hostname = N.toASCII(this.hostname));
          ...
          if (
            (-1 !== O
              ? ((this.search = s.substr(O)),
                (this.query = s.substr(O + 1)),
                e && (this.query = G.parse(this.query)),
                (s = s.slice(0, O)))
              : e && ((this.search = ""), (this.query = {})),
            s && (this.pathname = s),
            W[c] && this.hostname && !this.pathname && (this.pathname = "/"),
          ...
          (C.prototype.resolveObject = function (t) {
            ...
            for (
              var r = new C(), n = Object.keys(this), i = 0;
              i < n.length;
              i++
            ) {
              var o = n[i];
            ...
            _ &&
              ...
              (E =
                ...
                ((r.auth = E.shift()), (r.host = r.hostname = E.shift())));
            return (
              (g = g || (r.host && b.length)) && !A && b.unshift(""),
              b.length
                ? (r.pathname = b.join("/"))
      ...
      { "./util": 123, punycode: 101, querystring: 104 },
    ],
    123: [
      function (t, e, r) {
        "use strict";
    ...
    127: [
      ...
      { "./xml-http-request": 131, "./xml-http-request-event-target": 129 },
    ],
    128: [
      function (t, e, r) {
        "use strict";
    ...
    130: [
                ...
                if (null != t)
                  if ("string" == typeof t)
                    0 !== t.length &&
                      ...
                      (this._body = new o(t, "utf-8"));
                  else if (o.isBuffer(t)) this._body = t;
                  else if (t instanceof ArrayBuffer) {
                    for (
                      var e = new o(t.byteLength), r = new Uint8Array(t), n = 0;
                      n < t.byteLength;
                      n++
                    )
                      e[n] = r[n];
      ...
      { "./xml-http-request-event-target": 129, buffer: 54 },
    ],
    131: [
      function (m, t, y) {
        (function (n, i) {
            ...
            s = (function (r) {
              function s(t) {
                ...
                return (
                  (e.UNSENT = s.UNSENT),
                  (e.OPENED = s.OPENED),
                  (e.HEADERS_RECEIVED = s.HEADERS_RECEIVED),
                  (e.LOADING = s.LOADING),
                  (e.DONE = s.DONE),
                  (e.onreadystatechange = null),
                  (e.readyState = s.UNSENT),
                  (e.response = null),
                  (e.responseText = ""),
                  (e.responseType = ""),
                  (e.status = 0),
                  (e.statusText = ""),
                  (e.timeout = 0),
                  (e.upload = new p.XMLHttpRequestUpload()),
                  (e.responseUrl = ""),
                  (e.withCredentials = !1),
                  (e._method = null),
                  (e._url = null),
                  ...
                  (e._headers = {}),
                  (e._loweredHeaders = {}),
                  (e._mimeOverride = null),
                  (e._request = null),
                  (e._response = null),
                  (e._responseParts = null),
                  (e._responseHeaders = null),
                  (e._aborting = null),
                  (e._error = null),
                  (e._loadedBytes = 0),
                  (e._totalBytes = 0),
                  (e._lengthComputable = !1),
                  (e._restrictedMethods = {
                    CONNECT: !0,
                    TRACE: !0,
                    TRACK: !0,
                  }),
                  ...
                  (e._privateHeaders = { "set-cookie": !0, "set-cookie2": !0 }),
                  (e._userAgent =
                    "Mozilla/5.0 (" +
                    c.type() +
                    " " +
                    ...
                    " v8/" +
                    n.versions.v8),
                  (e._anonymous = t.anon || !1),
                  e
                );
              }
              return (
                t(s, r),
                (s.prototype.open = function (t, e, r, n, i) {
                  if (
                    (void 0 === r && (r = !0),
                    (t = t.toUpperCase()),
                    this._restrictedMethods[t])
                  )
                    throw new s.SecurityError(
                      "HTTP method " + t + " is not allowed in XHR"
                    );
                  var o = this._parseUrl(e, n, i);
                  this.readyState === s.HEADERS_RECEIVED || this.readyState,
                    (this._method = t),
                    (this._url = o),
                    (this._sync = !r),
                    (this._headers = {}),
                ...
                (s.prototype.send = function (t) {
                  ...
                  if (this._request)
                    throw new s.InvalidStateError("send() already called");
                ...
                (s.prototype._setReadyState = function (t) {
                  (this.readyState = t),
                    this.dispatchEvent(new f.ProgressEvent("readystatechange"));
                }),
                ...
                (s.prototype._onHttpResponse = function (t, e) {
                  ...
                  if (this._request === t) {
                    ...
                    (this._totalBytes = +n),
                      (this._lengthComputable = !!n),
                      this._setReadyState(s.HEADERS_RECEIVED);
                  }
                }),
                (s.prototype._onHttpResponseData = function (t, e) {
                  this._response === t &&
                    (this._responseParts.push(new i(e)),
                    (this._loadedBytes += e.length),
                    this.readyState !== s.LOADING &&
                      this._setReadyState(s.LOADING),
                ...
                (s.prototype._parseResponse = function () {
                  ...
                  switch (((this._responseParts = null), this.responseType)) {
                    ...
                    case "buffer":
                      return (
                        (this.responseText = null), void (this.response = e)
                      );
                    case "arraybuffer":
                      this.responseText = null;
                      for (
                ...
                (s.ProgressEvent = f.ProgressEvent),
                (s.InvalidStateError = l.InvalidStateError),
                (s.NetworkError = l.NetworkError),
                (s.SecurityError = l.SecurityError),
                (s.SyntaxError = l.SyntaxError),
                (s.XMLHttpRequestUpload = p.XMLHttpRequestUpload),
                (s.UNSENT = 0),
                (s.OPENED = 1),
                (s.HEADERS_RECEIVED = 2),
                (s.LOADING = 3),
                (s.DONE = 4),
                (s.cookieJar = d.CookieJar()),
                s
              );
            })(r.XMLHttpRequestEventTarget);
          ((y.XMLHttpRequest = s).prototype.nodejsHttpAgent = a.globalAgent),
            (s.prototype.nodejsHttpsAgent = u.globalAgent),
    ...
    "bignumber.js": [
      function (r, n, t) {
        !(function (t) {
          ...
          function tt(t, e) {
            return (
              (1 < t.length ? t.charAt(0) + "." + t.slice(1) : t) +
              (e < 0 ? "e" : "e+") +
              e
            );
          }
          ...
          if (
            ((e = (function t(e) {
              ...
              function B(t, e) {
                ...
                if (!(u instanceof B))
                  return (
                    w && M(26, "constructor call without new", t), new B(t, e)
                  );
                if (null != e && x(e, 2, 64, b, "base")) {
                  if (((a = t + ""), 10 == (e |= 0)))
                    return N(
                      (u = new B(t instanceof B ? t : a)),
                      d + u.e + 1,
                      g
                    );
                  if (
                    ((o = "number" == typeof t) && 0 * t != 0) ||
                    !new RegExp(
                      "^-?" +
                        (r = "[" + U.slice(0, e) + "]+") +
                        "(?:\\." +
                    ...
                    return P(u, a, o, e);
                  o
                    ? ((u.s = 1 / t < 0 ? ((a = a.slice(1)), -1) : 1),
                      w && 15 < a.replace(/^0\.0*|\./, "").length && M(b, q, t),
                      (o = !1))
                    : (u.s =
                        45 === a.charCodeAt(0) ? ((a = a.slice(1)), -1) : 1),
                    (a = C(a, 10, e, u.s));
                } else {
                  if (t instanceof B)
                    return (
                ...
                for (
                  r < 37 && (t = t.toLowerCase()),
                    0 <= f &&
                      ...
                      (E = 0),
                      (t = t.replace(".", "")),
                      (u = (h = new B(r)).pow(t.length - f)),
                      (E = s),
                      (h.c = Q(et(V(u.c), u.e), 10, e)),
                      (h.e = h.c.length)),
                    o = s = (c = Q(t, r, e)).length;
                  0 == c[--s];
                  c.pop()
                );
                if (!c[0]) return "0";
                ...
                return (
                  (t < e || r < t || t != rt(t)) &&
                    M(
                      n,
                      (i || "decimal places") +
                        (t < e || r < t ? " out of range" : " not an integer"),
                      t
                    ),
                  !0
                );
              ...
              return (
                ...
                (B.config = function () {
                  ...
                  return (
                    s((e = "DECIMAL_PLACES")) &&
                      ...
                      (d = 0 | t),
                    (n[e] = d),
                    s((e = "ROUNDING_MODE")) && x(t, 0, 8, 2, e) && (g = 0 | t),
                    (n[e] = g),
                    s((e = "EXPONENTIAL_AT")) &&
                      (Y(t)
                        ? x(t[0], -J, 0, 2, e) &&
                    ...
                    s((e = "CRYPTO")) &&
                      (t === !!t || 1 === t || 0 === t
                        ? ((k = !(!t || !I || "object" != typeof I)),
                          t && !k && w && M(2, "crypto unavailable", I))
                        : w && M(2, e + H, t)),
                    (n[e] = k),
                    s((e = "MODULO_MODE")) && x(t, 0, 9, 2, e) && (S = 0 | t),
                    (n[e] = S),
                    s((e = "POW_PRECISION")) && x(t, 0, J, 2, e) && (E = 0 | t),
                    (n[e] = E),
                    s((e = "FORMAT")) &&
                      ("object" == typeof t
                        ? (A = t)
                        : w && M(2, e + " not an object", t)),
                    (n[e] = A),
                    n
                  );
                }),
                ...
                (B.random =
                  ...
                  function (t) {
                    var e,
                      ...
                      u = new B(y);
                    if (
                      ((t = null != t && x(t, 0, J, 14) ? 0 | t : d),
                      (i = F(t / W)),
                      k)
                    )
                      if (I && I.getRandomValues) {
                        for (
                          e = I.getRandomValues(new Uint32Array((i *= 2)));
                          s < i;

                        )
                          9e15 <= (o = 131072 * e[s] + (e[s + 1] >>> 11))
                            ? ((r = I.getRandomValues(new Uint32Array(2))),
                              (e[s] = r[0]),
                              (e[s + 1] = r[1]))
                            : (a.push(o % 1e14), (s += 2));
                        s = i / 2;
                ...
                (P = function (t, e, r, n) {
                  ...
                  if (h.test(o)) t.s = isNaN(o) ? null : o < 0 ? -1 : 1;
                    ...
                    if (
                      ...
                      n &&
                        ((i = n), (o = o.replace(a, "$1").replace(u, "0.$1"))),
                      e != o)
                    )
                      return new B(o, i);
                    w && M(b, "not a" + (n ? " base " + n : "") + " number", e),
                      (t.s = null);
                  }
                  (t.c = t.e = null), (b = 0);
                }),
                ...
                (n.minus = n.sub =
                  function (t, e) {
                    ...
                    if (!a || !u) {
                      if (!c || !h)
                        return c ? ((t.s = -e), t) : new B(h ? this : NaN);
                      if (!c[0] || !h[0])
                        return h[0]
                          ? ((t.s = -e), t)
                          : new B(c[0] ? this : 3 == g ? -0 : 0);
                    }
                    if (
                      ((a = K(a)), (u = K(u)), (c = c.slice()), (s = a - u))
                    ) {
                      for (
                        (o = s < 0) ? ((s = -s), (i = c)) : ((u = a), (i = h)),
                          i.reverse(),
                          e = s;
                        e--;
                        i.push(0)
                  ...
                  function (t) {
                    ...
                    if (
                      (null != t &&
                        ...
                        1 !== t &&
                        0 !== t &&
                        (w && M(13, "argument" + H, t), t != !!t && (t = null)),
                      !n)
                    )
                      return null;
                  ...
                  return (
                    (null == t || x(t, 0, J, 15)) &&
                      N(
                        r,
                        ~~t + this.e + 1,
                        null != e && x(e, 0, 8, 15, L) ? 0 | e : g
                      ),
                    r
                  );
                }),
                (n.shift = function (t) {
                  return x(t, -o, o, 16, "argument")
                    ? this.times("1e" + rt(t))
                    : new B(
                        this.c && this.c[0] && (t < -o || o < t)
                          ? this.s * (t < 0 ? 0 : 1 / 0)
                          : this
                      );
                }),
                  ...
                  function () {
                    ...
                    if (
                      ...
                      for ((s = (a = r.e) + u) < 3 && (s = 0); ; )
                        if (
                          ((i = r),
                          (r = c.times(i.plus(m(this, i, u, 1)))),
                          V(i.c).slice(0, s) === (e = V(r.c)).slice(0, s))
                        ) {
                          if (
                            (r.e < a && --s,
                          ...
                          if (
                            !n &&
                            (N(i, i.e + d + 2, 0), i.times(i).eq(this))
                          ) {
                            r = i;
                            break;
                          }
                ...
                (n.times = n.mul =
                  function (t, e) {
                    ...
                    for (
                      n = K(this.e / W) + K(t.e / W),
                        t.s *= this.s,
                        (u = g.length) < (f = v.length) &&
                          ((d = g),
                          (g = v),
                          (v = d),
                          (i = u),
                ...
                (n.toDigits = function (t, e) {
                  ...
                  return (
                    (t =
                      null != t && x(t, 1, J, 18, "precision") ? 0 | t : null),
                    (e = null != e && x(e, 0, 8, 18, L) ? 0 | e : g),
                    t ? N(r, t, e) : r
                  );
                }),
                ...
                (n.toFixed = function (t, e) {
                  return T(
                    this,
                    null != t && x(t, 0, J, 20) ? ~~t + this.e + 1 : null,
                    e,
                    20
                  );
                }),
                (n.toFormat = function (t, e) {
                  var r = T(
                    this,
                    null != t && x(t, 0, J, 21) ? ~~t + this.e + 1 : null,
                    e,
                    21
                  );
                  if (this.c) {
                  ...
                  if (
                    (null != t &&
                      ...
                      ((h = s.isInt()) && !s.lt(y)) ||
                        ...
                        (t = !h && s.c && N(s, s.e + 1, 1).gte(y) ? s : null))),
                    !f)
                  )
                    return this.toString();
                  for (
                    c = V(f),
                      i = l.e = c.length - this.e - 1,
                      l.c[0] = G[(o = i % W) < 0 ? W + o : o],
                      t = !t || 0 < s.cmp(l) ? (0 < i ? l : p) : s,
                      o = _,
                      _ = 1 / 0,
                      s = new B(c),
                      a.c[0] = 0;
                    (u = m(s, l, 0, 1)), 1 != (n = r.plus(u.times(d))).cmp(t);

                  )
                    (r = d),
                      (d = n),
                      (p = a.plus(u.times((n = p)))),
                      (a = n),
                      (l = s.minus(u.times((n = l)))),
                      (s = n);
                  return (
                    (n = m(t.minus(r), d, 0, 1)),
                    (a = a.plus(n.times(p))),
                    ...
                    (e =
                      m(p, d, (i *= 2), g)
                        .minus(this)
                        .abs()
                        .cmp(m(a, r, i, g).minus(this).abs()) < 1
                ...
                (n.toPrecision = function (t, e) {
                  return T(
                    this,
                    null != t && x(t, 1, J, 24, "precision") ? 0 | t : null,
                    e,
                    24
                  );
                }),
